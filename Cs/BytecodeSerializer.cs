...
namespace Cnidaria.Cs
{
    ...
    public static class BytecodeSerializer
    {
        ...
        public static byte[] SerializeStackFunctions(IReadOnlyDictionary<int, BytecodeFunction> functions)
        {
        ...
        private static void WriteStackFunction(BinaryWriter bw, BytecodeFunction fn)
        {
