...
public sealed class PreprocessorEnvironment
{
        ...
        TargetInfo target, IReadOnlyDictionary<string, string>? extraPredefinedMacros = null)
    {
        ...
        macros["__SIZEOF_SHORT__"] = target.ShortLayout.Size.ToString();
        macros["__SIZEOF_INT__"] = target.IntLayout.Size.ToString();
        macros["__SIZEOF_LONG__"] = target.LongLayout.Size.ToString();
        macros["__SIZEOF_LONG_LONG__"] = target.LongLongLayout.Size.ToString();
        macros["__SIZEOF_FLOAT__"] = target.FloatLayout.Size.ToString();
        macros["__SIZEOF_DOUBLE__"] = target.DoubleLayout.Size.ToString();
        macros["__SIZEOF_LONG_DOUBLE__"] = target.LongDoubleLayout.Size.ToString();
