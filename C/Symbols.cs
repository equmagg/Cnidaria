...
public sealed class FieldSymbol : TypedSymbol
{
    ...
    /// <summary>Declared width of a bit-field, or null when the member occupies whole bytes</summary>
    public int? BitWidth { get; }

    public bool IsBitField => BitWidth.HasValue;
        ...
        : base(type, declaringSyntax)
    {
        ...
        BitWidth = bitWidth is null ? null : Math.Max(0, bitWidth.Value);
    }
}
